            ...
            <>
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-primary to-secondary text-white font-bold py-4 px-6 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
                  Proceed to Checkout
                </button>
